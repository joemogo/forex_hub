...
const out=observer.alexGObserveAndBuildLeanExport(input,{emitLeanZoneRequestV2:emitter.build,emitterDeps:{sha256Hex:sha}});
...
console.log('PASS -- actual observer composition emits exact LEAN v2 synthetic envelope in memory');
console.log('PASS -- application remains unwired: '+((html.match(/alexGObserveAndBuildLeanExport\s*\(/g)||[]).length===0));
console.log('---');
